                ...
                <div class="col-md-3 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="etudiant_details_super.php?id=<?php echo $row['EtudiantID']; ?>" class="btn btn-success">Afficher Details</a>
                        </div>
                    </div>
                </div>
            <?php
...
if (isset($_SESSION['success']) && $_SESSION['success'] != '') {
    ...
    <meta http-equiv="refresh" content="5; url = liste_etudiants_super.php" />';
