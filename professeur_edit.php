...
if(isset($_POST['editp_btn']))
{
    ...
    $query = "SELECT * FROM etudiants WHERE ProfesseurID='$ProfesseurID' ";
    ...
    foreach($query_run as $row)
    {
        ?>
            ...
            <div class="form-group">
                <label> Image de professeur</label>
                <input type="file" name="edit_professeurimage" value="<?php echo $row['Image'] ?>" class="form-control" placeholder="Entrer image de professeur">
            </div>
